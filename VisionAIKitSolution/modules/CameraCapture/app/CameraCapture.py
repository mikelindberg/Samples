...
class CameraCapture(object):
    ...
    def __displayTimeDifferenceInMs(self, endTime, startTime):
        return str(int((endTime-startTime) * 60000)) + " ms"
    ...
    def start(self):
        ...
        while True:
            ...
            if self.imageProcessingEndpoint != "":
                ...
                #forwarding outcome of external processing to the EdgeHub
                if __name__ == "__CameraCapture__":
                    
                    # Create blob service
                    bbs = BlockBlobService(account_name = self.accname, account_key = self.acckey)

                    # Create container bbs.create_container(self.container)
                    ...
                    res = bbs.create_blob_from_path(self.container, date_time, encodedFrame)
